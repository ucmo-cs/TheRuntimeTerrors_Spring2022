...
class Form():
    def __init__(self, request):
        ...
        self.totalRiskValue = (
                ...
                int(self.singlePilot) +
                int(self.capLess100in90) +
                int(self.offLess100in90) +
                int(self.duty12Hours) +
                int(self.flightTime) +
                int(self.crewRest) +
                int(self.verticalGuidance) +
                int(self.circlingApproach) +
                int(self.publishedApproach) +
                int(self.mountainous) +
                int(self.controlTower) +
                int(self.uncontrolledAir) +
                int(self.alternatePort) +
                int(self.elevation) +
                int(self.wetRunway) +
                int(self.contaiminatedRunway) +
                int(self.winter) +
                int(self.twilight) +
                int(self.night) +
                int(self.stopDist) +
                int(self.repositioning) +
                int(self.popUp) +
                int(self.international) +
                int(self.weatherReport) +
                int(self.storms) +
                int(self.turbulence) +
                int(self.visability) +
                int(self.rain) +
                int(self.snow) +
                int(self.ice) +
                int(self.surfaceWinds) +
                int(self.crossWinds) +
                int(self.brakeAction) +
                int(self.permit) +
                int(self.safetyItems) +
